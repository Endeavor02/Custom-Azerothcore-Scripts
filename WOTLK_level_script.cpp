...
enum
{
	min_level = 70,//Defines the min level the player must be
	max_level = 80 //Defines the max level the player can reach
};

class wotlk_level_token : public ItemScript
{
public:
	wotlk_level_token() : ItemScript("wotlk_level_token") { }
...
void AddSC_wotlk_level_token()
{
	new wotlk_level_token();
}
